  ...
  const countryOptions = [
    {
      ...
      label: (
        <span style={{ display: "inline-flex", alignItems: "center" }}>
          {" "}
          Ship To <img src={usa} alt="" width="20" />
        </span>
      ),
    },
    {
      ...
      label: (
        <span style={{ display: "inline-flex", alignItems: "center" }}>
          {" "}
          Ship To <img src={germany} alt="" width="20" />
        </span>
      ),
    },
    {
      ...
      label: (
        <span style={{ display: "inline-flex", alignItems: "center" }}>
          {" "}
          Ship To <img src={france} alt="" width="20" />
        </span>
      ),
    },
    {
      ...
      label: (
        <span style={{ display: "inline-flex", alignItems: "center" }}>
          {" "}
          Ship To <img src={itlay} alt="" width="20" />
        </span>
      ),
    },
    {
      ...
      label: (
        <span style={{ display: "inline-flex", alignItems: "center" }}>
          {" "}
          Ship To <img src={russia} alt="" width="20" />
        </span>
      ),
    },
    {
      ...
      label: (
        <span style={{ display: "inline-flex", alignItems: "center" }}>
          {" "}
          Ship To <img src={australia} alt="" width="20" />
        </span>
      ),
    },
    {
      ...
      label: (
        <span style={{ display: "inline-flex", alignItems: "center" }}>
          {" "}
          Ship To <img src={england} alt="" width="20" />
        </span>
      ),
    },
    {
      ...
      label: (
        <span style={{ display: "inline-flex", alignItems: "center" }}>
          {" "}
          Ship To <img src={china} alt="" width="20" />
        </span>
      ),
    },
    {
      ...
      label: (
        <span style={{ display: "inline-flex", alignItems: "center" }}>
          {" "}
          Ship To <img src={dubai} alt="" width="20" />
        </span>
      ),
    },
    {
      ...
      label: (
        <span style={{ display: "inline-flex", alignItems: "center" }}>
          {" "}
          Ship To <img src={scoltland} alt="" width="20" />
        </span>
      ),
    },
  ];
      ...
      <div className="header flex justify-between items-center bg-white">
        ...
        <div className="search flex">
          <input
            type="text"
            placeholder="Search"
            className="border-2 rounded-l-[5px] border-blue-500 w-[300px] focus:border-2 focus:border-red-500-500"
          />
          <select className="category border-2 border-blue-500 border-l-0">
            <option value="All category" defaultValue="All Category">
              All Category
            </option>
